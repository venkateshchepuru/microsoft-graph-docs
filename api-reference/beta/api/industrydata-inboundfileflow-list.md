...
If successful, this method returns a `200 OK` response code and a collection of [inboundFileFlow](../resources/inboundfileflow.md) objects in the response body.
